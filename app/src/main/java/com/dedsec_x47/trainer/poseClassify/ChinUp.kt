...
class ChinUp {
    ...
    //1 - UP 2 - DOWN
    private val WESAngle1 = 30                  //W - wrist E - Elbow S - Shoulder
    private val SHKAngle = 170                  // for both positions
    private val HKAAngle = 120                  // these 2 vals will be same

    // you could create an array of each joints angle instead of 2 vars -- bt both takes same amt of memory -- so anything is ok
    private val WESAngle2 = 155
