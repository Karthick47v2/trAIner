...
class HammerCurl {
    ...
    // Angle vals for HammerPress SET1

    //1 -hands UP 2 - DOWN
    private val WESAngle1 = 180                  //W - wrist E - Elbow S - Shoulder
    private val SHKAngle = 20                  // for both positions
    ...
    private fun getHammerCurlAngles(person: Human){
