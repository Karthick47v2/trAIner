...
class DeadliftInst : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_instructions_deadlift)

        val btn: Button = findViewById(R.id.btnStartDeadLift)

        btn.setOnClickListener(){
            poseDetect.currentExercise = Exercise.Deadlift
